(function ($, DataTable) {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: function (dt) {
            return '<i class="icon-file-excel mr-2"></i> ' + dt.i18n('buttons.excel', 'Excel');
        },
    ...
    DataTable.ext.buttons.postExcelVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="icon-file-excel mr-2"></i> ' + dt.i18n('buttons.excel', 'Excel (only visible columns)');
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: function (dt) {
            return '<i class="icon-file-spreadsheet mr-2"></i> ' + dt.i18n('buttons.csv', 'CSV');
        },
    ...
    DataTable.ext.buttons.postCsvVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="icon-file-spreadsheet mr-2"></i> ' + dt.i18n('buttons.csv', 'CSV (only visible columns)');
        },
    ...
    //
    //     text: function (dt) {
    //         return '<i class="icon-file-pdf mr-2"></i> ' + dt.i18n('buttons.pdf', 'PDF');
    //     },
    //
    //     action: function (e, dt, button, config) {
