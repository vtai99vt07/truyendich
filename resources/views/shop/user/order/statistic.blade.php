...
<section class="container mt-4 content main-list-user">
    <h2 class="text-center" style="margin-bottom: 20px;">Đơn mua chương vip</h2>
    <div class="mt-4 table-responsive">
        ...
        <table class="table text-center">
            ...
            <tbody>
                                                    ...
                                                    <table class="table text-center mt-4"  style="min-width:600px;">
                                                        ...
                                                        @foreach($list->orderChapter as $val => $value)
                                                            <tr>
                                                                ...
                                                                @endif
                                                                <td><span class="w-100">{{ (int)$value->total_chapter_buy }} lượt mua</span></td>
                                                                <td><span class="w-100">{{ number_format((int)$value->total_price) }} vàng</span></td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
                                                    </table>
                ...
                @else
                <tr>
                    <td colspan="6">Bạn chưa bán được chương truyện nào !</td>
                </tr>
                @endif
            </tbody>
          </table>
